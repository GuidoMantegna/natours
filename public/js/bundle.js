  ...
  return (_ref2 = _ref2 || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          /* we need to reload the page which would then send the invalid cookie basically to the server,
          (the one that we just received without a token), and then we are no longer logged in, 
          and therefore then our user menu will disappear */
...
var displayMap = function displayMap(locations) {
  ...
  var bounds = L.latLngBounds(points).pad(0.75);
...
var bookTour = function bookTour(_x) {
  return (_ref = _ref || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51NsjohIfTsArGACug7EYOlmExDR95wfQjIKzly4NTOgUoGEJQE96dI4iro3Cbuc3W9J2FLY30K5UgjugTJyx88GQ00Ko4lInEz');
          _context.prev = 1;
          _context.next = 4;
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  e.preventDefault();
  // in order to process the photo, we kind of needed to programmatically recreate a multi-part form data
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          // clean the inputs when submiting
...
},{"./login":"login.js","./mapbox":"mapbox.js","./updateSettings":"updateSettings.js","./stripe":"stripe.js","./alerts":"alerts.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
